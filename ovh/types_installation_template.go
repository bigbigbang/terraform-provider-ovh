...
type InstallationTemplateProject struct {
	...
	Os    InstallationTemplateProjectOs `json:"os,omitempty"`
}

type InstallationTemplateProjectOs struct {
...
func (v InstallationTemplateProjectOs) ToMap() map[string]interface{} {
	obj := make(map[string]interface{})
